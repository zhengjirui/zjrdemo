...
public class RoundImageView extends AbsRoundImageView {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            leftTopRadius = ta.getDimension(R.styleable.RoundImageView_leftTopRadius, 20);
            rightTopRadius = ta.getDimension(R.styleable.RoundImageView_rightTopRadius, 20);
            rightBottomRadius = ta.getDimension(R.styleable.RoundImageView_rightBottomRadius, 20);
            leftBottomRadius = ta.getDimension(R.styleable.RoundImageView_leftBottomRadius, 20);
            ta.recycle();
        }
    }
