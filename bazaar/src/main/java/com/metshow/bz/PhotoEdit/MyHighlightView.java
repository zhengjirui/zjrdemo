package com.metshow.bz.PhotoEdit;
...
import com.metshow.bz.PhotoEdit.drawable.EditableDrawable;
import com.metshow.bz.PhotoEdit.drawable.FeatherDrawable;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
	...
	public void setScaleable(boolean scaleable) {
		...
		if (scaleable) {
			mAnchorRotate = App.getInstance().getResources().getDrawable(R.drawable.aviary_resize_knob);
		} else {
			mAnchorRotate = null;
		}
	}
	...
	public void setDeleteable(boolean deleteable) {
		if (deleteable) {
			mAnchorDelete = App.getInstance().getResources().getDrawable(R.drawable.aviary_delete_knob);
		} else {
			mAnchorDelete = null;
		}
	}
	...
	public void draw(final Canvas canvas) {
		...
		if (is_selected || is_focused) {
			...
			if (mShowAnchors) {
				...
				outlinePaint.setStrokeWidth(ViewUtil.dip2px(App.getInstance(), 1));
