...
public class ExitActivityTransition {
    ...
    public void exit(final Activity activity,Runnable run) {
        if (interpolator == null) {
            interpolator = new DecelerateInterpolator();
        }
        TransitionAnimation.startExitAnimation(moveData, interpolator,run);
    }

    public ExitActivityTransition setView(View v){
        moveData.toView = v;
        return this;
    }
