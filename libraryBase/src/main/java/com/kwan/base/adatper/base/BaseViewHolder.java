...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setImageUrl(final int viewId, String imageUrl) {
        ImageView view = getView(viewId);
        Glide.with(context)
                .load(imageUrl)
                .crossFade()
                ...
                .into(new ViewTarget<ImageView, GlideDrawable>(view) {
                    @Override
	...
	public BaseViewHolder setCircleUrl(final int viewId, String imageUrl) {
    ...
    public BaseViewHolder setImageUrlByWidth(int viewId, String imageUrl, final int width) {
        ...
        Glide.with(context)
                ...
                .into(new SimpleTarget<Bitmap>() {
                    ...
                    public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                        ...
                        view.setLayoutParams(new LinearLayout.LayoutParams(width, viewHeight));
