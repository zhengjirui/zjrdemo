...
import com.kwan.base.adatper.base.animation.AlphaInAnimation;
import com.kwan.base.adatper.base.animation.BaseAnimation;
import com.kwan.base.adatper.base.animation.ScaleInAnimation;
import com.kwan.base.adatper.base.animation.SlideInBottomAnimation;
import com.kwan.base.adatper.base.animation.SlideInLeftAnimation;
import com.kwan.base.adatper.base.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	protected static final int HEADER_VIEW = 111;
	protected static final int LOADING_VIEW = 222;
	protected static final int FOOTER_VIEW = 333;
	protected static final int EMPTY_VIEW = 555;
...
//        }
	...
	public void upData(int position, T item) {
	...
	public void add(int position, T item) {
		...
		notifyItemInserted(position + getHeaderViewsCount() + getFooterViewsCount());
	}
	...
	public int getItemViewType(int position) {
		if (mHeaderView != null && position == 0) {
			return HEADER_VIEW;
		} else if (mEmptyView != null && mEmptyEnable) {
			return EMPTY_VIEW;
		} else if (mFooterView != null && position == mData.size() + getHeaderViewsCount()) {
			if (mNextLoadEnable)
				return LOADING_VIEW;
			else
				return FOOTER_VIEW;
	...
	public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
		...
		switch (holder.getItemViewType()) {
			...
			case FOOTER_VIEW:
				break;
			default:
				convert((BaseViewHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewsCount()), holder.getLayoutPosition() - getHeaderViewsCount());
				initItemClickListener(holder, (BaseViewHolder) holder);
				break;
		}
	...
	protected void initItemClickListener(final RecyclerView.ViewHolder holder, BaseViewHolder baseViewHolder) {
		if (onRecyclerViewItemClickListener != null) {
			baseViewHolder.convertView.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
					Log.d("kwan", "holder.getLayoutPosition()::" + holder.getLayoutPosition() + "  getHeaderViewsCount()::" + getHeaderViewsCount());
