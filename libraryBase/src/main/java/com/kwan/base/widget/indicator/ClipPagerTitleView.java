package com.kwan.base.widget.indicator;
...
import com.kwan.base.widget.indicator.abs.IMeasurablePagerTitleView;
...
public class ClipPagerTitleView extends View implements IMeasurablePagerTitleView {
    ...
    private void init(Context context) {
        int textSize = ViewUtil.dip2px(context, 16);
		textSizeSelect =ViewUtil.dip2px(context, 18);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setTextSize(textSize);
        int padding = ViewUtil.dip2px(context, 10);
	...
	public void onSelected(int index, int totalCount) {
		...
		Log.d("ClipPagerTitleView","onSelected::index:"+index+"::totalcount::"+totalCount);
	}

	@Override
	public void onDeselected(int index, int totalCount) {
		Log.d("ClipPagerTitleView","onDeselected::index:"+index+"::totalcount::"+totalCount);
	}
    ...
    public int getContentLeft() {
		...
		//return getLeft() + getWidth()  - contentWidth ;
