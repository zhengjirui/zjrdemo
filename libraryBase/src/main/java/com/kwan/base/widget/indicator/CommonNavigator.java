...
import com.kwan.base.widget.indicator.abs.IPagerNavigator;
        ...
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
					...
					//lp = new LinearLayout.LayoutParams(ScreenUtil.getScreenWidth(getContext())/5, LayoutParams.MATCH_PARENT);
