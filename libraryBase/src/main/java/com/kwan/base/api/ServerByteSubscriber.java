 ...
 */
public class ServerByteSubscriber extends Subscriber<byte[]> {

    private ServerByteSubscriberListener mListener;
    public int vocational_id = -1;
    public HashMap<String,Object> exData;


    public ServerByteSubscriber(ServerByteSubscriberListener listener) {
        mListener = listener;
    }
    ...
    @Override
    public void onNext(byte[] tServerJsonMsg) {
